					...
					<div id="content" class="content" role="main">
						...
						<form method="post" class="woocommerce-form woocommerce-form-register register text-center" action="/register_user" style="text-align:center">
							...
							<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide " style="width:50%;margin:auto">
								...
								<label for="reg_email">كلمه السر  <span class="required">*</span></label>
								...
								<label for="reg_email">cv<span class="required">*</span></label>
								<input type="file" class="woocommerce-Input woocommerce-Input--text input-text " name="password" id="reg_email" autocomplete="email" value=""> </p>
							</div>
						...
						<button type="submit"
									class="woocommerce-Button button" name="register" value="Register">تسجيل</button>
							</p>

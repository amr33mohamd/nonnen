  ...
  <div class="masthead inline-header right widgets shadow-decoration shadow-mobile-header-decoration small-mobile-menu-icon dt-parent-menu-clickable show-device-logo show-mobile-logo sticky-off fixed-masthead sticky-off" role="banner">
    ...
    <header class="header-bar" style="height: 60px; transition: all 0.3s ease 0s;">
      ...
      <div class="branding"><a class="sticky-logo" href="http://watrax.com/2020/opfor/july/ali/">
        ...
        <a class="" href="http://watrax.com/2020/opfor/july/ali/"><img class=" preload-me" src="./Explore – Nooneen Design_files/Mian-logo-main.png"
            srcset="http://watrax.com/2020/opfor/july/ali/wp-content/uploads/2020/10/Mian-logo-main.png 144w, http://watrax.com/2020/opfor/july/ali/wp-content/uploads/2020/10/Rt-logo.png 287w" width="100" height="70" sizes="144px"
      ...
      <ul id="primary-menu" class="main-nav level-arrows-on outside-item-custom-margin" role="navigation">
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-141 first "><a href="/" data-level="1"><span class="menu-item-text"><span
                class="menu-text">How Its Work</span></span></a>

        </li>


        <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-224 current_page_item menu-item-226 act"><a href="/gallery" data-level="1"><span
              class="menu-item-text"><span class="menu-text">Our Gallery</span></span></a></li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-321"><a href="/shop" data-level="1"><span class="menu-item-text"><span class="menu-text">Shop</span></span></a></li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-708"><a href="/login" data-level="1"><span class="menu-item-text"><span class="menu-text">Login</span></span></a></li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-711"><a href="/register" data-level="1"><span class="menu-item-text"><span class="menu-text">Register</span></span></a></li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-711"><a href="/register-designer" data-level="1"><span class="menu-item-text"><span class="menu-text">Join as designer</span></span></a></li>
        ...
        <li class="menu-item wpml-ls-slot-17 wpml-ls-item wpml-ls-item-en wpml-ls-current-language wpml-ls-menu-item wpml-ls-first-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-17-en">
          <a href="http://watrax.com/2020/opfor/july/ali/explore/" data-level="1"><span class="menu-item-text"><span class="menu-text"><img class="wpml-ls-flag" src="./Explore – Nooneen Design_files/en.png" alt="English"></span></span></a></li>
      </ul>
      <div class="mini-widgets"><a href="http://watrax.com/2020/opfor/july/ali/quiz/"
          class="microwidget-btn mini-button header-elements-button-1 show-on-desktop near-logo-first-switch in-menu-second-switch microwidget-btn-bg-on microwidget-btn-hover-bg-on disable-animation-bg border-off hover-border-off btn-icon-align-right first last"><span>Get
            Started</span></a></div>
    </header>
  ...
  <div class="dt-mobile-header mobile-menu-show-divider dt-parent-menu-clickable">
    <div class="mobile-header-scrollbar-wrap">
      ...
      <ul id="mobile-menu" class="mobile-main-nav" role="navigation">
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-141 first has-children"><a href="/" data-level="1"><span class="menu-item-text"><span
                class="menu-text">How Its Work</span></span></a>
        ...
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-226"><a href="/designs" data-level="1"><span class="menu-item-text"><span class="menu-text">Our Gallery</span></span></a>
        </li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-321"><a href="/shop" data-level="1"><span class="menu-item-text"><span class="menu-text">Shop</span></span></a></li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-708"><a href="/login" data-level="1"><span class="menu-item-text"><span class="menu-text">Login</span></span></a></li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-629 current_page_item menu-item-711 act"><a href="/register" data-level="1"><span
        ...
        <li class="menu-item wpml-ls-slot-17 wpml-ls-item wpml-ls-item-en wpml-ls-current-language wpml-ls-menu-item wpml-ls-first-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-17-en">
          <a href="/register" data-level="1"><span class="menu-item-text"><span class="menu-text"><img class="wpml-ls-flag" src="/Register – Nooneen Design_files/en.png" alt="English"></span></span></a></li>
      </ul>
